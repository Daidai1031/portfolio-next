...
export default function AllProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <div className="pb-10 lg:pb-32 space-y-12 lg:space-y-64">
        {categoryOrder.map(category => {
          ...
          return (
            <section key={category} id={category} style={{ scrollMarginTop: '80px' }}>
              ...
              {/* Mobile: 2-col grid — smaller images */}
      ...
      {/* Footer */}
      <footer
        className="border-t border-gray-200 py-10 lg:py-16 bg-gray-50 mt-8 lg:mt-48"
        style={{ paddingLeft: NAV_PADDING, paddingRight: NAV_PADDING }}
      >
