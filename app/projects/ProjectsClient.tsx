...
const allProjectOrder = [
  "tangible/socratidesk",
  "tangible/subway-telltale",
  "creative/encoded-elevation",
  "creative/camino-quest-board-game",
  "tangible/geomelody",
  "software/teaguard",
  "software/into-place",
  "tangible/prompt",
  "software/ceta-prototype",
  "built/passive-self-leveling-cup-holder",
  "creative/ironic-shaxi",
  "built/3d-printed-bamboo-structure",
  "built/dupont-paper-plywood-installation",
  "tangible/adaptive-tension-structure",
  "creative/interactive-pocket-parks",
  "creative/urban-systems-storymap",
  "built/river-life-museum-xiguan",
  "built/kindergarten-spatial-design",
  "built/huanshi-east-city-renewal",
] as const;
