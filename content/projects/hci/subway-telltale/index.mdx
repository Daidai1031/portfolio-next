...
The project results in a working, battery-powered keychain device that provides real-time subway arrival information through ambient visual feedback. The form factor makes the interaction genuinely effortless — a glance while grabbing your keys gives you everything you need.

The telltale demonstrates how ubiquitous computing can reduce friction in everyday decisions by meeting users at the right moment, in the right form, with just enough information.
